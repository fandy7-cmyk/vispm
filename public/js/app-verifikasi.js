...
async function renderVerifikasi() {
  ...
  document.getElementById('mainContent').innerHTML = `
    <div class="page-header">
      <h1><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;color:var(--primary)"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>Verifikasi Usulan${role === 'Pengelola Program' ? ` — Indikator: ${currentUser.indikatorAksesString || 'Semua'}` : ''}</h1>
    </div>
  ...
  <span style="font-size:12.5px;color:#92400e"><b>Verifikasi Ulang</b> — Hanya menampilkan <b>${displayInds.length} indikator</b> yang sebelumnya bermasalah dan perlu diverifikasi ulang.${_keteranganExtra}</span>`;
    ...
    if (thead) {
      if (usePerIndikator && canAct && window._verifTTOk) {
        thead.innerHTML = `<tr><th style="background:#0d9488;color:white">No</th><th style="background:#0d9488;color:white">Indikator</th><th style="background:#0d9488;color:white;text-align:center;min-width:80px">Target Tahunan</th><th style="background:#0d9488;color:white;text-align:center">Target Bulan Ini</th><th style="background:#0d9488;color:white;text-align:center">Realisasi Bulan Ini</th><th style="background:#0d9488;color:white;text-align:center;min-width:80px">Sisa Target Tahunan</th><th style="background:#0d9488;color:white;text-align:center">Capaian</th><th style="background:#0d9488;color:white;text-align:center">Data Dukung</th><th style="background:#0d9488;color:white;text-align:center;min-width:170px">Verifikasi</th></tr>`;
      } else {
        thead.innerHTML = `<tr><th style="background:#0d9488;color:white">No</th><th style="background:#0d9488;color:white">Indikator</th><th style="background:#0d9488;color:white;text-align:center!important;min-width:80px">Target Tahunan</th><th style="background:#0d9488;color:white;text-align:center!important">Target Bulan Ini</th><th style="background:#0d9488;color:white;text-align:center!important">Realisasi Bulan Ini</th><th style="background:#0d9488;color:white;text-align:center!important;min-width:80px">Sisa Target Tahunan</th><th style="background:#0d9488;color:white;text-align:center!important">Capaian</th><th style="background:#0d9488;color:white;text-align:center!important">Data Dukung</th></tr>`;
      }
    }
